...
namespace GameLAN
{
    public class ChessBoardManager
    {
        ...
        public ChessBoardManager(Panel chessBoard, TextBox playerName, PictureBox mark)
        {
            ...
            {
                new Player("P.A.T", Image.FromFile(Application.StartupPath + "\\x.png")),
                new Player("EDITH", Image.FromFile(Application.StartupPath + "\\o.png"))
            };
            CurrentPlayer = 0;
        }
        #endregion
            ...
            for (int i = 0; i < Cons.CHESS_BOARD_WIDTH; i++)
            {
                ...
                for (int j = 0; j < Cons.CHESS_BOARD_HEIGHT; j++)
                {
                    Button btn = new Button()
                    {
                        ...
                        Location = new Point(oldButton.Location.X + oldButton.Width, oldButton
                    .Location.Y),
